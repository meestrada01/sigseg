...
import { postPresentacion } from 'store/slices/inventario';
import toast from 'react-hot-toast';

import PresentacionLis from './PresentacionLis';

const Presentacion = ({ open, handleCloseDialog }) => {
    ...
    const Guardar = async (u) => {
        ...
        if (Val1) {
            await dispatch(postPresentacion(u));
        }
    };
    ...
    return (
        <Dialog open={open} onClose={handleCloseDialog} fullWidth maxWidth="lg">
            {open && (
                <>
                    <DialogTitle>Presentacion</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ my: 0 }}>
                            ...
                            <Grid item xs={6} md={8}>
                                <PresentacionLis ItemsTipoProducto={ItemsTipoProducto} />
                            </Grid>
                        </Grid>
                    </DialogContent>
                    <DialogActions>
