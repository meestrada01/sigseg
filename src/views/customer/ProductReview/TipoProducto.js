...
import { postTipoProducto } from 'store/slices/inventario';
import toast from 'react-hot-toast';

import TipoProductoLis from './TipoProductoList';

const TipoProducto = ({ open, handleCloseDialog }) => {
    ...
    const Guardar = async (u) => {
        ...
        if (Val1) {
            await dispatch(postTipoProducto(u));
        }
    };
                ...
                <>
                    ...
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ my: 0 }}>
                            <Grid item xs={6} md={4}>
                                <form onSubmit={formik.handleSubmit}>
                                    ...
                                    <Grid item xs={12} md={12}>
                                        <Stack>
                                            <InputLabel required> Tipo de Producto</InputLabel>
                                            <TextField
                                                id="detalle"
                                                name="detalle"
                            ...
                            <Grid item xs={6} md={8}>
                                <TipoProductoLis ItemsTipoProducto={ItemsTipoProducto} />
                            </Grid>
                        </Grid>
                    </DialogContent>
                    <DialogActions>
